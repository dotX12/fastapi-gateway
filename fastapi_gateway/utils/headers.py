...
def inheritance_service_headers(
    ...
    forced_gateway_headers = ['server', 'date', 'content-encoding', 'content-type', 'content-length']
    return {
...
def generate_headers_for_microservice(headers: Headers) -> MutableHeaders:
    ...
    forced_gateway_headers = ['host', 'content-type', 'accept-encoding', 'content-length']
